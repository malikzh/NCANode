# XML.verifyWithSecurityHeader

Верифицирует XML документ в формате `WSSec`, как требуется для работы с сервисом smartbridge (sb.egov.kz).
...
Известно, что разные сервисы smartbridge могут возвращать данные в разных форматах.
Не гарантировано, что ncanode умеет верифицировать подписи во всех форматах. Подробнее см. [здесь](https://github.com/kolesa-team/NCANode/pull/2#issuecomment-788862354). 