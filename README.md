...
- Поддержка Docker
- Поддержка TSP **NEW!!!**
- Поддержка возможности подписи произвольных данных (не только XML) **NEW!!!**
- Поддержка работы с CMS ( [Cryptographic Message Syntax](https://en.wikipedia.org/wiki/Cryptographic_Message_Syntax) ) **NEW!!!**
